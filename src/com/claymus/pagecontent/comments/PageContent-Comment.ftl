		...
		<div id="PageContent-Pratilipi-Comment-FormDiv"  data-id="${ review.getId() }" data-type="REVIEW">
			<#if userData.getEmail()?? && review.getUserId() != userData.getId()>
				<#if reviewLikesSeq?seq_contains( userData.getId()?c )>
					<img onclick="vote( this )" title="Upvote" alt="Upvote" data-value="0" />
				<#else>
					<img onclick="vote( this )" title="Upvote" alt="Upvote" data-value="1" />
				</#if>
			<#else>
				<img class="disabled" title="Upvote" alt="Upvote" data-value="0" />
			</#if>
			...
			<#if userData.getEmail()?? && review.getUserId() != userData.getId()>
				<#if reviewDislikesSeq?seq_contains( userData.getId()?c )>
					<img onclick="vote( this )" title="Downvote" alt="Downvote" data-value="0"/>
				<#else>
					<img onclick="vote( this )" title="Downvote" alt="Downvote" data-value="1"/>
				</#if>
			<#else>
				<img class="disabled" title="Downvote" alt="Downvote" data-value="0" />
			</#if>			
			...
			<br/>
			<textarea id="PageContent-Pratilipi-Comment-Form-Textarea" placeholder="Reply to above review" rows=2 cols=80 onkeydown="onEnter(this)"></textarea>
		</div>
		...
		<div id="PageContent-Pratilipi-Comment-List">
			<#list commentDataSeq as commentData>
				...
				<div class="comment" data-id="${ commentSeq[0] }" data-type="COMMENT">
					...
					<script>
						console.log ( ${ userData.getId()?c } + "/" + ${ commentSeq[1] } );
						console.log ( ${ ( userData.getId()?c == commentSeq[1] )?c } );
					</script>
					...
					<#if userData.getEmail()?? && userData.getId()?c != commentSeq[1]>
						<#if commentLikesSeq?seq_contains( userData.getId()?c )>
							<img onclick="vote( this )" title="Upvote" alt="Upvote" src="/war/image/like.jpg" data-value="0">
						<#else>
							<img onclick="vote( this )" title="Upvote" alt="Upvote" src="/war/image/like.jpg" data-value="1">
						</#if>
					<#else>
						<img class="disabled" title="Upvote" alt="Upvote" src="/war/image/like.jpg" data-value="0">
					</#if>
					...
					<#if userData.getEmail()?? && userData.getId()?c != commentSeq[1]>
						<#if commentDislikesSeq?seq_contains( userData.getId()?c )>
							<img onclick="vote( this )" title="Downvote" alt="Downvote" src="/war/image/like.jpg" data-value="0">
						<#else>
							<img onclick="vote( this )" title="Downvote" alt="Downvote" src="/war/image/like.jpg" data-value="1">
						</#if>
					<#else>
						<img class="disabled" title="Downvote" alt="Downvote" src="/war/image/like.jpg" data-value="0">
					</#if>
